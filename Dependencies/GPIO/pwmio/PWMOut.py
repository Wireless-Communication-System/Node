...
"""
Remixed with https://github.com/adafruit/Adafruit_CircuitPython_CharLCD/blob/c290a14cd3a3a189796085a6a25caf3bc4e3e55f/adafruit_character_lcd/character_lcd.py
"""
...
class PWMOut:
    ...
    def _open(self, pin, duty=0, freq=500, variable_frequency=False):
        ...
        self._pwmpin = GPIO.PWM(pin, freq)
    ...
    def _map(self, xval, in_min, in_max, out_min, out_max):
        """Added to display colors properly"""
    ...
    def duty_cycle(self, duty_cycle):
        ...
        """Added the next line to format duty cycle within class"""
        duty_cycle = int(self._map(duty_cycle, 0, 100, 65535, 0))
